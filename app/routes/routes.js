...
var logs = require(__base + 'app/controllers/logs.js'),
	system = require(__base + 'app/controllers/system.js'),
	platforms = require(__base + 'app/controllers/platforms.js'),
	devices = require(__base + 'app/controllers/devices.js'),
	scenarios = require(__base + 'app/controllers/scenarios.js'),
	tasks = require(__base + 'app/controllers/tasks.js'),
	conditions = require(__base + 'app/controllers/conditions.js'),
	users = require(__base + 'app/controllers/users.js'),
	stats = require(__base + 'app/controllers/stats.js'),
	recommendations = require(__base + 'app/controllers/recommendations.js'),
